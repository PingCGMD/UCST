...
liste_name = ["rdf_COM_AAm.xvg", "rdf_COM_BMDO.xvg", "rdf_self_AAm.xvg", "rdf_self_BMDO.xvg"]
...
liste_temperature_dissolution =["/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_270K_D","/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_280K_D_redo","/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_300K_D","/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_310K_D","/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_340K_D","/media/ping/Anastazia/Ping/UCST_prodrug/AAm-BMDO-P13/1.25mM/Dissolution/1.25mM_370K_D"]
...
#    output_file = open("{}_average_".format(str_temperature)+i, "w")
    ...
    for i in liste_name:
        ...
        for j in range(index2,25+len(lines1[index2:])):
            X.append(float(lines1[j][1:12]))
       #    print(X)
            Y1.append((float(lines1[j][13:26])+float(lines2[j][13:26]))/2)
